...
public class Order {
    ...
    public void displayOrder() {
        ...
        if (delivery != null) {
            ...
            System.out.println("Delivery not set. Proceed to pickup");
        }
    ...
    // write order info to file to be saved, uses exception handling 
    public void writeOrderToFile(String filename) {
        try (PrintWriter writer = new PrintWriter(new FileWriter(filename))) {
            ...
            writer.println("===================================");
            System.out.println("Your order has been recorded and saved to: " + filename);
        } catch (IOException e) {
