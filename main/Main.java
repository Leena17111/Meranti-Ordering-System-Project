...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            JPasswordField pwdField = new JPasswordField(); //mask password input
            ...
            String userID = "U" + ThreadLocalRandom.current().nextInt(100, 1000); // user id is U + 3 random digit

            // Based on user type, create corresponding object either student or staff or proceed as visitor
            if (userType == 1) {
                try {
                    String meritInput = JOptionPane.showInputDialog("Enter your merit points:"); // get merit points for student discount
            ...
            //Display selected vendor's menu
            ...
            // final amount based on discount and delivery if applicable
